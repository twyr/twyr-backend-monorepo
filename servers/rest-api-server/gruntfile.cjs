...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		exec: {
			...
			'consolidate-build': {
				command:
					'mkdir -p ./../../buildresults/rest-api-server && rm -rf  ./../../buildresults/rest-api-server && mv ./buildresults ./../../buildresults/rest-api-server'
			},
			'consolidate-docs': {
				command:
					'mkdir -p ./../../docs/rest-api-server && rm -rf ./../../docs/rest-api-server && mv ./docs/api ./../../docs/rest-api-server && rm -rf ./docs'
			},
			deps: {
