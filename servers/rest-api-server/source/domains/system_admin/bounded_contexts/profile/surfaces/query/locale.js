...
export class Locale extends SystemAdminBaseSurface {
	 ...
	 * @example
	 * $ curl -X GET -H "Content-Type: application/json" -b ./cookies.txt ${base_url}/api/v1/system_admin/profile/locale/
	 *
	 * @example
	 * $ curl -X GET -H "Content-Type: application/json" -b ./cookies.txt ${base_url}/api/v1/system_admin/profile/locale/${localeId}
	 */
