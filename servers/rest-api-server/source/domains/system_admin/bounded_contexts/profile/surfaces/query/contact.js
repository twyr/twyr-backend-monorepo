 ...
 */
export class Contact extends SystemAdminBaseSurface {
	// #region Constructor
	/**
	 * @category REST API Server/Domains/System Admin
	 * @subcategory Profile/Surfaces/Query
	 ...
	 * @example
	 * $ curl -X GET -H "Content-Type: application/json" -b ./cookies.txt ${base_url}/api/v1/system_admin/profile/contact/
	 *
	 * @example
	 * $ curl -X GET -H "Content-Type: application/json" -b ./cookies.txt ${base_url}/api/v1/system_admin/profile/contact/${contactId}
	 */
