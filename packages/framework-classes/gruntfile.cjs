...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		exec: {
			...
			'consolidate-build': {
				command:
					'mkdir -p ./../../buildresults/framework-classes && rm -rf  ./../../buildresults/framework-classes && mv ./buildresults ./../../buildresults/framework-classes'
			},
			'consolidate-docs': {
				command:
					'mkdir -p ./../../docs/framework-classes && rm -rf ./../../docs/framework-classes && mv ./docs/api ./../../docs/framework-classes && rm -rf ./docs'
			},
			deps: {
