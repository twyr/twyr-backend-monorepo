 ...
 *
 * @classdesc
 * The Base Class for all Surfaces.
 */
export class EVASBaseSurface extends EVASBaseArtifact {
	// #region Constructor
	/**
	 * @category Packages/Framework Classes
	 * @subcategory Base Classes
	 ...
	 *
	 * @description
	 * Returns the interface exposed by this Surface's
