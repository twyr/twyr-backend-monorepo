...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		exec: {
			...
			'consolidate-build': {
				command:
					'mkdir -p ./../../buildresults/server-dependency-manager && rm -rf  ./../../buildresults/server-dependency-manager && mv ./buildresults ./../../buildresults/server-dependency-manager'
			},
			'consolidate-docs': {
				command:
					'mkdir -p ./../../docs/server-dependency-manager && rm -rf ./../../docs/server-dependency-manager && mv ./docs/api ./../../docs/server-dependency-manager && rm -rf ./docs'
			},
			deps: {
