...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		exec: {
			...
			'consolidate-build': {
				command:
					'mkdir -p ./../../buildresults/api-registry && rm -rf  ./../../buildresults/api-registry && mv ./buildresults ./../../buildresults/api-registry'
			},
			'consolidate-docs': {
				command:
					'mkdir -p ./../../docs/api-registry && rm -rf ./../../docs/api-registry && mv ./docs/api ./../../docs/api-registry && rm -rf ./docs'
			},
			deps: {
