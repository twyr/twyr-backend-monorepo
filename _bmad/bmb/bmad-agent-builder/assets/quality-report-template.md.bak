...
_What this agent does well — preserve these during optimization:_
...
_Issues that prevent the agent from working correctly:_
...
_How different user archetypes experience this agent:_
