...
_What this skill does well — preserve these during optimization:_
...
_Issues that prevent the workflow/skill from working correctly:_
...
_How different user archetypes experience this skill:_
